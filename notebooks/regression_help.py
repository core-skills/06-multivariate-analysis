...
Author: Neil Francis, October 2018
"""
...
def gaussian_fwhm_pdf(X, height, x_position, fwhm):
    """Returns gaussian probability distribution function, given FWHM
...
def gaussian_pdf(X, area, x_position, standard_deviation):
    ...
    So this function multiplies the height of the gaussian by this factor and
...
def _apply_convolution_kernels(x_axis_vector, intensity, two_theta_angle,
